...
<link href="../resources/css/fullscreenstyle.css" type="text/css"
	rel="stylesheet" />
<link type="text/css" rel="stylesheet" media="all"
	href="../resources/css/Tipswindown.css" />
<script type="text/javascript" src="../resources/js/jquery-1.8.2.min.js"></script>
<script type="text/javascript"
	src="../resources/js/jquery.fullscreenslides.js"></script>
												...
												<c:if test="${project.status!=0}">
													...
													<div class="sortes4">
														...
														<input type="hidden" name="id" value="${pp.id}"> <input
															...
															value="${pp.programmer.id}"> <input type="hidden"
							...
							<div id="win">
								...
								<form class="signup-form clearfix" method="post"
									...
									<input type="hidden" name="bargainNo"
										...
										id="imgnums" value="${imgnums}"> <input type="file"
										name="file" accept="image/*"> <input type="file"
										name="file1" accept="image/*"> <input type="file"
										name="file2" accept="image/*"> <input type="submit"
										id="submit" name="type" class="buttones" value="上传">
								</form>
							</div>
						</div>
