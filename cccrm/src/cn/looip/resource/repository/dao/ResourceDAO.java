...
//	public int insertProgrammer2(Manager manager);
	...
	//按条件查询程序员
	public List<Programmer> searchprogrammer(@Param("department") int department,@Param("status") int status,@Param("pagerIndex")int pagerIndex,@Param("pagerNum")int pagerNum);
