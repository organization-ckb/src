...
public class ResourceServiceImpl implements ResourceService
{
	...
	// 按条件查询程序员
	@Override
	public List<Programmer> searchprogrammer(int department,int status,String pagerIndex,int pagerNum)
	{
		int Index = 0;
		if (pagerIndex != null)
		{
		...
		return resourceDAO.searchprogrammer(department,status,Index,pagerNum);
	}
